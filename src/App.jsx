...
const TEMPLATE_CREATOR_ID = “**template_creator**”;
...
<select value={ALL_CATEGORIES.includes(customCat) ? customCat : “Other”} onChange={e => { if (e.target.value !== “**custom**”) setCustomCat(e.target.value); else setCustomCat(””); }} style={{ …inp, marginBottom: customCat === “” || !ALL_CATEGORIES.includes(customCat) ? 8 : 0 }}>
{ALL_CATEGORIES.map(c => <option key={c} value={c}>{c}</option>)}
