...
const SEED_ATHLETES = [
  ...
  { id: "test001", name: "Test Athlete", type: "Adult Performance", level: "V8-V10" },
];
...
const TEST_ATHLETE_PLAN = {
      ...
      "days": [
        {
          ...
          "exercises": [
            {
              "id": "ta1001",
              "text": "Fingerboard Warmup",
              "category": "Fingerboard / Hangboard",
              "sets": "18 sets",
              "notes": "10s on: 20s rest. (1) 5 sets 3 finger drag (2) 5 sets open hand (3) 2 sets index middle (4) 2 sets middle ring (5) 4 sets half crimp."
            },
            {
              "id": "ta1002",
              "text": "Max Hangs \u2014 Two-Arm, 3 Finger Drag (10s on: 2min off)",
              "category": "Fingerboard / Hangboard",
              "sets": "5 sets",
              "notes": "Use the 20mm edge. Add weight if bodyweight feels easy. Treat first 2 sets as warmup. Goal: find the weight at which you can barely hold 10 seconds."
            },
            {
              "id": "ta1003",
              "text": "Max Hangs \u2014 Two-Arm, Half Crimp (10s on: 2min off)",
              "category": "Fingerboard / Hangboard",
              "sets": "3 sets",
              "notes": "Same edge as above. Rest fully. Note your edge size and weight."
            },
            {
              "id": "ta1004",
              "text": "Tension Board \u2014 Limit Problems",
              "category": "Board Climbing (Kilter/Tension)",
              "sets": "4-6 boulders x 1 hr",
              "notes": "Choose problems you believe are attainable in 5-10 attempts. Avoid small crimps \u2014 prefer open hand and pinch holds where possible."
            },
            {
              "id": "ta1005",
              "text": "Weighted Pull-Ups",
              "category": "Strength (pull-ups, rows, etc.)",
              "sets": "3 sets x 5 reps",
              "notes": "Choose weight such that rep 5 is nearly a fail. Drop weight between sets if needed."
            },
            {
              "id": "ta1006",
              "text": "Bench Press",
              ...
              "notes": "Sets to failure. Choose weight so you land in the 6-8 rep range."
            }
          ]
        },
        {
          "label": "Day 2 - Power and Skills",
          "exercises": [
            {
              "id": "ta1007",
              "text": "Fingerboard Warmup",
            ...
            },
            {
              "id": "ta1008",
              "text": "Flash Attempts",
              "category": "Limit Bouldering",
              "sets": "8-10 boulders x 1 hr",
              "notes": "Pick ambitious flash attempts \u2014 problems you think you can do in 1-3 tries. 3 good attempts then move on."
            },
            {
              "id": "ta1009",
              "text": "Comp Boulders",
              "category": "Movement / Drills",
              "sets": "3-5 boulders",
              "notes": "4-minute drills when crowds permit. Focus on reading and executing movement efficiently."
            },
            {
              "id": "ta1010",
              "text": "Slab Practice",
              "category": "Movement / Drills",
              "sets": "30 mins",
              "notes": "Hard slabs or footwork makeups. Leave your power at the door \u2014 this is technique time."
            },
            {
              "id": "ta1011",
              "text": "Weighted Pull-Up Negatives",
              "category": "Strength (pull-ups, rows, etc.)",
              "sets": "3 sets x 3 reps",
              "notes": "Use 70-80% of your 1RM. Lower slowly (5 seconds down). If you don't know your 1RM, use this session to find it instead."
            },
            {
              "id": "ta1012",
        ...
        },
        {
          ...
          "exercises": [
            ...
            },
            {
              "id": "ta1014",
              "text": "4x4s",
              "category": "ARC / Endurance",
              "sets": "4 sets",
              "notes": "Choose NON-CRIMPY boulders around V4-V6. 4 laps with no rest, then 4 minutes rest between sets. Pump should be the limiter, not difficulty."
            },
            {
              "id": "ta1015",
              "text": "Route Endurance",
              "category": "ARC / Endurance",
              "sets": "3 sets",
              "notes": "Choose one option: (A) Route trifectas with a partner \u2014 3 pumpy routes back to back, no rest. (B) Solo circuit \u2014 set a 30-40 move circuit and take redpoint goes with 5-10 min rest between attempts."
            }
          ]
        }
      ]
      ...
      "days": [
        {
          ...
          "exercises": [
            ...
            },
            {
              ...
              "category": "Fingerboard / Hangboard",
              "sets": "5 sets",
              "notes": "Try to beat last week's weight or edge size by a small margin. Note results."
            },
            {
              "id": "ta1018",
              "text": "Max Hangs \u2014 Two-Arm, Half Crimp (10s on: 2min off)",
              "category": "Fingerboard / Hangboard",
              "sets": "4 sets",
              "notes": "Same as above. Push to beat last week."
            },
            {
              "id": "ta1019",
              "text": "Tension Board \u2014 Project",
              "category": "Board Climbing (Kilter/Tension)",
              "sets": "1 boulder x 45 mins",
              "notes": "Pick a problem you believe will take more than 2 sessions. Treat each move like its own problem. Log your progress."
            },
            {
              "id": "ta1020",
              "text": "Tension Board \u2014 Limit Problems",
              "category": "Board Climbing (Kilter/Tension)",
              "sets": "3-4 boulders x 45 mins",
              "notes": "Attainable in 5-10 attempts. Mix styles \u2014 don't always pick your strengths."
            },
            {
              "id": "ta1021",
              "text": "Weighted Pull-Ups",
              ...
              "notes": "Increase weight slightly from Week 1 if it felt manageable."
            },
            {
              "id": "ta1022",
              "text": "Bench Press",
              "category": "Strength (pull-ups, rows, etc.)",
              "sets": "3 sets x 6-8 reps",
              "notes": "Match or slightly exceed Week 1 weight."
            }
          ]
        },
        {
          ...
          "exercises": [
            ...
            },
            {
              ...
              "text": "Flash Attempts",
              "category": "Limit Bouldering",
              "sets": "10 boulders x 1 hr",
              "notes": "Include any problems you nearly flashed last week as retro-flash attempts. 3 good tries then move on."
            },
            {
              "id": "ta1025",
              "text": "Comp Boulders",
              "category": "Movement / Drills",
              "sets": "3-5 boulders",
              "notes": "4-minute drills. Focus on moving with intention \u2014 no panicked feet."
            },
            {
              "id": "ta1026",
              "text": "Slab Practice",
              "category": "Movement / Drills",
              "sets": "30-45 mins",
              "notes": "Hard slabs or static movement makeups."
            },
            {
              "id": "ta1027",
              "text": "Weighted Pull-Up Negatives",
              "category": "Strength (pull-ups, rows, etc.)",
              "sets": "3 sets x 3 reps",
              "notes": "Increase weight from Week 1 if negatives felt controlled."
            },
            {
              "id": "ta1028",
              "text": "Incline Bench Press",
        ...
        },
        {
          ...
          "exercises": [
            ...
            },
            {
              ...
              "category": "ARC / Endurance",
              "sets": "4 sets",
              "notes": "Bump difficulty slightly from Week 1 \u2014 try V5-V7. Still NON-CRIMPY. Rest exactly 4 minutes between sets."
            },
            {
              "id": "ta1031",
              "text": "Route Endurance",
              "category": "ARC / Endurance",
              "sets": "3 sets",
              "notes": "Same format as Week 1. If you set a circuit last week, give it proper redpoint attempts now."
            }
          ]
        },
        {
          "label": "Day 4 - Shoulders + Campus",
          "exercises": [
            {
              "id": "ta1032",
              "text": "Fingerboard Warmup",
            ...
            },
            {
              ...
              "sets": "3-5 makeups x 30 mins",
              "notes": "Set yourself 3-move campus makeups. Hold positions today \u2014 work the links next time. No crimps."
            },
            {
              "id": "ta1034",
              "text": "Seated External Rotation",
              "category": "Strength (pull-ups, rows, etc.)",
              "sets": "3 sets x 10 reps",
              "notes": "A la Aidan Roberts. Choose weight so you near failure at rep 10."
            },
            {
              "id": "ta1035",
              "text": "Lat Pulls",
              ...
              "notes": "Pull into a front lever from dead hang. Once impossible, let legs go limp and pull until belly button faces ceiling. 2 min rest between sets."
            }
          ]
        }
      ]
      ...
      "days": [
        {
          ...
          "exercises": [
            ...
            },
            {
              ...
              "category": "Fingerboard / Hangboard",
              "sets": "5 sets",
              "notes": "This is a peak week \u2014 push for a new max. Rest fully between sets."
            },
            {
              "id": "ta1038",
              "text": "Max Hangs \u2014 Two-Arm, Half Crimp (10s on: 2min off)",
              "category": "Fingerboard / Hangboard",
              "sets": "4 sets",
              "notes": "Push for a new max. Note your numbers."
            },
            {
              "id": "ta1039",
              "text": "Tension Board \u2014 Project",
              "category": "Board Climbing (Kilter/Tension)",
              "sets": "1 boulder x 45 mins",
              "notes": "Return to your Week 2 project. Push for links. If you've sent it, pick a new one."
            },
            {
              "id": "ta1040",
              "text": "Tension Board \u2014 Limit Problems",
              "category": "Board Climbing (Kilter/Tension)",
              "sets": "3-5 boulders x 45 mins",
              "notes": "Include at least one anti-style climb. Push hard."
            },
            {
              "id": "ta1041",
              "text": "Weighted Pull-Ups",
              "category": "Strength (pull-ups, rows, etc.)",
              "sets": "4 sets x 5 reps",
              "notes": "Aim for a new weight PR if Week 2 felt solid."
            },
            {
              "id": "ta1042",
              "text": "Bench Press",
              "category": "Strength (pull-ups, rows, etc.)",
              "sets": "3 sets x 6-8 reps",
              "notes": "Push weight up another notch."
            }
          ]
        },
        {
          ...
          "exercises": [
            ...
            },
            {
              ...
              "category": "Limit Bouldering",
              "sets": "10 boulders x 1 hr",
              "notes": "Go for problems a grade harder than last week. 3 attempts max per problem."
            },
            {
              "id": "ta1045",
              "text": "Comp Boulders",
              "category": "Movement / Drills",
              "sets": "4-6 boulders",
              "notes": "4-minute drills. Increase number of problems from prior weeks."
            },
            {
              "id": "ta1046",
              "text": "Slab Practice",
              "category": "Movement / Drills",
              "sets": "30-45 mins",
              "notes": "Push slab difficulty this week."
            },
            {
              "id": "ta1047",
              "text": "Weighted Pull-Up Negatives",
              "category": "Strength (pull-ups, rows, etc.)",
              "sets": "3 sets x 3 reps",
              "notes": "Push to a new weight max for negatives."
            },
            {
              "id": "ta1048",
              "text": "Incline Bench Press",
        ...
        },
        {
          ...
          "exercises": [
            ...
            },
            {
              ...
              "category": "ARC / Endurance",
              "sets": "5 sets",
              "notes": "Add a fifth set this week. Still NON-CRIMPY. 4 min rest between sets."
            },
            {
              "id": "ta1051",
              "text": "Route Endurance",
              "category": "ARC / Endurance",
              "sets": "4 sets",
              "notes": "Add a set from prior weeks. Push route difficulty if able."
            }
          ]
        },
        {
          ...
          "exercises": [
            ...
            },
            {
              ...
              "text": "Campus Makeups",
              "category": "System Board",
              "sets": "5 makeups x 45 mins",
              "notes": "Work the links on makeups from Week 2. Add new harder ones."
            },
            {
              "id": "ta1054",
              "text": "Seated External Rotation",
              ...
              "notes": "Add a set from Week 2. Near failure at rep 10."
            },
            {
              "id": "ta1055",
              "text": "Lat Pulls",
              "category": "Strength (pull-ups, rows, etc.)",
              "sets": "3 sets to failure",
              "notes": "Same as Week 2. Push for more reps or better positions."
            }
          ]
        }
      ]
      ...
      "days": [
        {
          ...
          "exercises": [
            ...
            },
            {
              ...
              "category": "Fingerboard / Hangboard",
              "sets": "6 sets",
              "notes": "Peak week. Max effort. Note every set."
            },
            {
              "id": "ta1058",
              "text": "Max Hangs \u2014 Two-Arm, Half Crimp (10s on: 2min off)",
              "category": "Fingerboard / Hangboard",
              "sets": "5 sets",
              "notes": "Max effort. Rest fully."
            },
            {
              "id": "ta1059",
              "text": "Tension Board \u2014 Project",
              "category": "Board Climbing (Kilter/Tension)",
              "sets": "1 boulder x 1 hr",
              "notes": "Full send effort. If you top out, pick the next hardest thing."
            },
            {
              "id": "ta1060",
              "text": "Tension Board \u2014 Limit Problems",
              "category": "Board Climbing (Kilter/Tension)",
              "sets": "3-5 boulders x 45 mins",
              "notes": "Hardest limit problems of the block. Leave nothing in the tank."
            },
            {
              "id": "ta1061",
              "text": "Weighted Pull-Ups",
              "category": "Strength (pull-ups, rows, etc.)",
              "sets": "5 sets x 5 reps",
              "notes": "Peak weight. Drop if needed but aim for 5 clean reps."
            },
            {
              "id": "ta1062",
              "text": "Bench Press",
        ...
        },
        {
          ...
          "exercises": [
            ...
            },
            {
              ...
              "category": "Limit Bouldering",
              "sets": "10 boulders x 1 hr",
              "notes": "Peak flash session. Go for problems that feel just out of reach."
            },
            {
              "id": "ta1065",
              "text": "Comp Boulders",
              "category": "Movement / Drills",
              "sets": "5-6 boulders",
              "notes": "4-minute drills. Most volume of the block."
            },
            {
              "id": "ta1066",
              "text": "Slab Practice",
              "category": "Movement / Drills",
              "sets": "45 mins",
              "notes": "Hardest slabs of the block."
            },
            {
              "id": "ta1067",
              "text": "Weighted Pull-Up Negatives",
              "category": "Strength (pull-ups, rows, etc.)",
              "sets": "4 sets x 3 reps",
              "notes": "Add a set from Week 3. Max weight."
            },
            {
              "id": "ta1068",
              "text": "Incline Bench Press",
        ...
        },
        {
          ...
          "exercises": [
            ...
            },
            {
              ...
              "category": "ARC / Endurance",
              "sets": "5 sets",
              "notes": "Hardest boulders of the block for 4x4s. Limit yourself to NON-CRIMPY. Rest exactly 4 min."
            },
            {
              "id": "ta1071",
              "text": "Route Endurance",
              "category": "ARC / Endurance",
              "sets": "4 sets",
              "notes": "Max route difficulty for the block. Full send on your circuit."
            }
          ]
        },
        {
          ...
          "exercises": [
            ...
            },
            {
              ...
              "category": "System Board",
              "sets": "5 makeups x 45 mins",
              "notes": "Link your hardest campus makeups of the block. Push for sends."
            },
            {
              "id": "ta1074",
              "text": "Seated External Rotation",
              "category": "Strength (pull-ups, rows, etc.)",
              "sets": "4 sets x 10 reps",
              "notes": "Heaviest of the block. Near failure at rep 10."
            },
            {
              "id": "ta1075",
              "text": "Lat Pulls",
              ...
              "notes": "Add a set. Push for more reps than Week 3."
            }
          ]
        }
      ]
      ...
      "days": [
        {
          ...
          "exercises": [
            ...
            },
            {
              ...
              "category": "Fingerboard / Hangboard",
              "sets": "3 sets",
              "notes": "Deload week \u2014 drop to 60% of peak weight. Focus on feel, not performance."
            },
            {
              "id": "ta1078",
              "text": "Easy Board Climbing",
              "category": "Board Climbing (Kilter/Tension)",
              "sets": "30-45 mins",
              "notes": "Problems 2-3 grades below your limit. Smooth, controlled movement only. No projecting."
            },
            {
              "id": "ta1079",
              "text": "Weighted Pull-Ups",
              ...
              "notes": "Light weight \u2014 60% of peak. Just keep the pattern alive."
            }
          ]
        },
        {
          "label": "Day 2 - Movement",
          "exercises": [
            {
              "id": "ta1080",
              "text": "Fingerboard Warmup",
            ...
            {
              "id": "ta1081",
              "text": "Bouldering Mileage",
              "category": "Limit Bouldering",
              "sets": "60-90 mins",
              "notes": "Easy, fun bouldering well below your limit. No projecting. Focus on movement quality and enjoyment."
            },
            {
              "id": "ta1082",
              "text": "Slab Practice",
              "category": "Movement / Drills",
              "sets": "30 mins",
              "notes": "Low-stakes technique work. Relax and flow."
            }
          ]
        },
        {
          "label": "Day 3 - Light Fitness",
          "exercises": [
            {
              "id": "ta1083",
              "text": "Fingerboard Warmup",
            ...
            },
            {
              ...
              "category": "ARC / Endurance",
              "sets": "2 x 20 mins",
              "notes": "Continuous easy traversing or laps. Stay at 4/10 effort. Flush out fatigue from the block."
            },
            {
              "id": "ta1085",
              "text": "Forearm Stretching Routine",
              "category": "Recovery / Mobility",
              "sets": "10-15 mins",
              "notes": "Thorough forearm and wrist stretching. Take your time."
            }
          ]
        }
      ]
  ...
  "blockStart": "",
  "blockEnd": "",
  "blockNotes": "# 5-Week Intermediate Block\n\n## Who This Is For\nThis block is designed for a climber operating around the **V8-V10** range \u2014 past the early intermediate stage, building toward advanced. You have a solid base of strength and movement, and you're ready to train with more structure and intentionality.\n\n## Block Goals\n- **Finger strength**: Build two-arm max hang strength on 20mm edge in both 3-finger drag and half crimp\n- **Power**: Develop limit bouldering ability through board climbing and flash attempts\n- **Fitness**: Expand endurance capacity through 4x4s and route endurance\n- **Antagonist health**: Consistent bench, incline bench, external rotation, and lat work to balance the pulling load\n\n## Structure\n- **Weeks 1-2**: Establish baselines, build habits, moderate intensity\n- **Weeks 3-4**: Peak load \u2014 push strength, power, and volume to new highs\n- **Week 5**: Deload \u2014 flush fatigue, maintain movement, arrive fresh for the next block\n\n## Key Notes\n- **No small crimps on the fingerboard or board during max hang days** \u2014 save your pulleys for the climbing\n- **Log your numbers** every session: edge size, added weight, pull-up weight. Progress is invisible without data\n- **Rest days matter** as much as training days. Sleep, eat, and recover like it's part of the plan \u2014 because it is",
  "blockUpdate": "",
  "blockUpdateAt": null,
  "volumePublished": true
};
